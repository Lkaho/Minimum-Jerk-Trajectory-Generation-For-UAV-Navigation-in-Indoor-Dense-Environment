...
{	
	...
	protected:
		...
		double getManhattan(GridNodePtr node1, GridNodePtr node2);
		double getHeu(GridNodePtr node1, GridNodePtr node2);
		double getEulideanHeu(GridNodePtr node1, GridNodePtr node2);
	...
	public:
		...
		double calCollisionCost(GridNodePtr gridnode);
};
